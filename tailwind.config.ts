...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['"IBM Plex Sans Thai"', '"Sarabun"', '"Prompt"', ...defaultTheme.fontFamily.sans],
        heading: ['"Sarabun"', '"Prompt"', ...defaultTheme.fontFamily.sans],
        nav: ['"IBM Plex Sans Thai"', '"Sarabun"', ...defaultTheme.fontFamily.sans],
        prompt: ['"Sarabun"', '"Prompt"', ...defaultTheme.fontFamily.sans],
      },
      colors: {
